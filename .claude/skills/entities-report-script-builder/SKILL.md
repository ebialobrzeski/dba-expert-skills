...
2. **Column Definitions**: Table structure matching the query output (must include ServerName, DatabaseName)
   - Reference `.claude/assets/entities/DatabaseSchema.sql` for accurate data types from the sample database schema
...
- Reference `.claude/assets/entities/DatabaseSchema.sql` to match temp table column data types with actual database schema