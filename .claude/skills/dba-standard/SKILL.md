---
name: dba-standard
description: Cross-skill standards for all DBA performance analysis work - P0/P1/P2 rule hierarchy, risk assessment requirements, evidence-based analysis, output template, and anti-patterns. Load alongside any DBA analysis skill (execution plan analysis, index review, blocking, configuration, tempdb, sp_WhoIsActive) to apply the shared rules and output format.
---
...
3. **Load specific skill** - Use the skills mapping in CLAUDE.md
